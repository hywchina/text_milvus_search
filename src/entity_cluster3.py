...
# 聚类前图
axes[0].scatter(emb_2d[:,0], emb_2d[:,1], s=30, alpha=0.7)
axes[0].set_title(f'Before Clustering\nEntities: {len(emb_2d)}')
axes[0].set_xlabel('PC1')
axes[0].set_ylabel('PC2')

# 聚类后图
axes[1].scatter(centroids[:,0], centroids[:,1], s=50, marker='X')
axes[1].set_title(f'After Clustering\nEntities: {len(centroids)}')
...
print("Clustering complete. Results saved to output.json, plot saved as 'clustering_comparison.png'.")
